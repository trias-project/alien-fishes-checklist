...
In the description extension we want to include **native range** (`raw_origin`) and **pathway** (`raw_pathway_s`). We'll create a separate data frame for both and then combine these with union.
...
pathway %<>% mutate(mapped_value = case_when (
  cbd_standard != "unintentional" ~ paste("cbd_2014_pathway:", cbd_standard),
