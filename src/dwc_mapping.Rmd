...
The data are maintained in [this Google Spreadsheet](https://docs.google.com/spreadsheets/d/1LeXXbry2ArK2rngsmFjz_xErwE1KwQ8ujtvHNmTVA6E/edit#gid=961223689).
...
```{r}
readr::write_csv(raw_data, here("data", "raw", "alien_fishes_checklist_dump.csv"), na = "")
```
